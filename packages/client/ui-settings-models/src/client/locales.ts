...
export const en = {
  ...
  signInOpen: 'Open the sign-in page',
  signInCode: 'Code: {code}',
  signInAnswer: 'Continue',
  signInAnswering: 'Continuing\u2026',
  signInCancel: 'Cancel sign-in',
  signInAuthorized: 'Signed in. Its models are now available in the model picker.',
  signInCancelled: 'Sign-in cancelled.',
  signInFailed: 'Sign-in failed: {message}',
  signInRunning: 'A sign-in for this provider is already running.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  signInAnswering: '继续中…',
  signInCancel: '取消登录',
  signInAuthorized: '已登录。它的模型现在可以在模型选择器里选了。',
  signInCancelled: '登录已取消。',
  signInFailed: '登录失败：{message}',
  signInRunning: '这个提供方已经有一次登录在进行中。',
